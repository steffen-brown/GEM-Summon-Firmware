...
class ExitParking:
    def __init__(self):
        ...
        self.speed = 0.0
        self.desired_speed = 1  # m/s, reference speed
    ...
    def synced_cb(self, rgb_msg: Image, depth_msg: Image):
        ...
        if self.updated_lane_distance_lane_distance is None:
    ...
    def run(self):
        ...
        if self.lane_distance is None and not rospy.is_shutdown():
            self.lane_distance = 8.5  # meters
            rospy.loginfo_throttle(2.0, "hardcoded the lane_distance to 8.5 m")
