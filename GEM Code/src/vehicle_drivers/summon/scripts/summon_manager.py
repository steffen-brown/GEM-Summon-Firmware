...
class SummonManager:
    ...
    def __init__(self):
        ...
        self.goal_long = None
        self.goal_lat = None
        self.prev_goal_lat = None
        self.prev_goal_long = None
    ...
    def pull_out_activator(self):
        if self.prev_goal_long is not None and self.prev_goal_long is not None:
            if self.prev_goal_lat is not self.goal_lat or self.prev_goal_long is not self.goal_long:
    ...
    def goal_long_callback(self, msg):
        self.prev_goal_long = self.goal_long
    ...
    def goal_lat_callback(self, msg):
        self.prev_goal_lat = self.goal_lat
    ...
    def insnavgeod_callback(self, msg):
        ...
        rospy.loginfo(f"INS Heading: {current_heading} degrees")
